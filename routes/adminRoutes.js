...
// router.post('/ReturnRequestHandle', adminAuth, orderController.handleReturnRequest);
...
// router.post('/banner/add', upload.single('image'), bannerController.addBanner);
// router.get('/banner/edit/:id', bannerController.editBanner);
// router.post('/banner/update/:id', upload.single('image'), bannerController.updateBanner);
// router.get('/banner/delete/:id', bannerController.deleteBanner);
